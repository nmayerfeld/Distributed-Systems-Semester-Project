...
public class Message {
    ...
    /**
     * takes the content of the message as well as the metadata and puts it into a byte[] called network payload
     * contains:
     *      message type char
     *      request id
     *      0/1 boolean representation for error occurred
     *      senderPort
     *      length in bytes of sender Host string
     *      bytes of senderHost string
     *      receiver port
     *      receriver host string byte length
     *      receiver host string in bytes
     *      length of contents bytes
     *      contents byte []
     */
